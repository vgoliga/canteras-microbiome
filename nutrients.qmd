...
The environmental availability of certain nutrients on which microbes depend can deeply shape the composition of the microbiome. Nutrients chemical diversity is large, in this project we will classify them into two main groups:
...
Observing the molar concentration distributions in #fig-nutrients-overview, we can pinpoint an evident difference between organic and inorganic nutrients. That is, organic nutrients concentration ranges are two to three orders of magnitude higher, with TOC close to 100 μM, and TON around 10 μM. This is representative of the Redfield ratio ($C:N:P = 106:16:1$), which establishes one order of magnitude difference between carbon and nitrogen elemental concentrations in oceanic organic matter. From a statistical perspective, distributions with two clear heaps ---known as *bimodal distributions*--- like those of TON and PO4³⁻ likely represent clearly identifiable environmental states based on nutrient availability. It can be hypothesized that anthropogenic input of nutrient could be a driving factor of such processes.
